...
export default class EventsModal extends Component {
    ...
    handleSubmit = e => {
        ...
        if (NameValidData.isValid && DescriptionValidData.isValid && DateValidData.isValid && TimeValidateData.isValid) {
            this.props.handleSubmit({name, description, date, start_time, end_time, full_day});
        } else {
            this.setState({
                ...this.state,
    ...
    render() {
        const {name, date, description, start_time, end_time, full_day, disabled, NameError, DescriptionError, DateError, TimeError} = this.state;
        ...
        return (
            <div className="modal">
                <form className="modal__form">
                    ...
                    <Input name={"name"} value={name} onChange={this.handleInputChange} labelText={"Name"} errorMessage={NameError}/>
                    <Textarea name={"description"} value={description} type={"text"} onChange={this.handleInputChange} labelText={"Description"} errorMessage={DescriptionError}/>
                    <Input type={"date"} name={"date"} value={date} onChange={this.handleInputChange} labelText={"Date"} errorMessage={DateError}/>
                    <Input type={"time"} name={"start_time"} value={start_time} onChange={this.handleInputChange} labelText={"Start Time"} disabled={disabled} errorMessage={TimeError}/>
                    <Input type={"time"} name={"end_time"} value={end_time} onChange={this.handleInputChange} labelText={"End Time"} disabled={disabled} errorMessage={TimeError}/>
