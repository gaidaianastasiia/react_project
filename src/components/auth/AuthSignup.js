...
export default class AuthSignup extends Component {
  ...
  render() {
    const {email, password, confPassword} = this.state.user;
    const {emailErrMessage, passErrMessage, confPassErrMessage, serverErrMessage, showLoader, isRedirect} = this.state;
    ...
    return (
      <section className="auth">
        <form action="#" className="auth__form">
          ...
          <Input type={"password"} name={"confPassword"} value={confPassword} onChange={this.handleInputChange} labelText={"Enter your password again for verification"} errorMessage={confPassErrMessage}/>
